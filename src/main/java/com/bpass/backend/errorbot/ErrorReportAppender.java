package com.bpass.backend.errorbot;

import static com.bpass.backend.errorbot.util.JsonUtils.toPrettyJson;
import static com.bpass.backend.errorbot.util.MdcUtil.AGENT_DETAIL_MDC;
import static com.bpass.backend.errorbot.util.MdcUtil.BODY_MDC;
import static com.bpass.backend.errorbot.util.MdcUtil.HEADER_MAP_MDC;
import static com.bpass.backend.errorbot.util.MdcUtil.PARAMETER_MAP_MDC;
import static com.bpass.backend.errorbot.util.MdcUtil.REQUEST_URI_MDC;
import static com.bpass.backend.errorbot.util.MdcUtil.getFromMdc;
import static org.apache.commons.text.StringEscapeUtils.unescapeJava;

import ch.qos.logback.classic.spi.ILoggingEvent;
import ch.qos.logback.core.UnsynchronizedAppenderBase;
import com.bpass.backend.errorbot.config.LogConfig;

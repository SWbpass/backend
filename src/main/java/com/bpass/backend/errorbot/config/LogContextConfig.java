package com.bpass.backend.errorbot.config;

import ch.qos.logback.classic.LoggerContext;
import com.bpass.backend.errorbot.ErrorLogsRepository;
import com.bpass.backend.errorbot.ErrorReportAppender;
import com.bpass.backend.errorbot.filter.CollectRequestDataFilter;
import com.bpass.backend.errorbot.filter.MultiReadableHttpServletRequestFilter;

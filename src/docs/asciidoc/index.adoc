...
operation::signup-store[snippets='http-request,http-response']
...
[[entry]]
=== 출입 기록하기
operation::entry[snippets='http-request,http-response']

[[exit]]
=== 퇴장 기록하기
operation::exit[snippets='http-request,http-response']

[[visitLogs]]
== 출입 기록 조회하기
operation::visit[snippets='http-request,http-response']
...
[[admin-visit-logs]]
== 출입 기록 조회(관리자)
operation::admin-visit[snippets='http-request,http-response']

[[fcm]]
== fcm 세팅
[[registerToken]]
== 토큰 등록
operation::registerToken[snippets='http-request,http-response']